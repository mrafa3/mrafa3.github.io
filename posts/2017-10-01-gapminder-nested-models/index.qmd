...
```{r visualize_models, include=TRUE, echo=FALSE, fig.height=6.2}
...
```{r joyplot_nested_model_fit, include=TRUE, echo=FALSE, fig.height=6.2}
glance_gapminder_model %>% 
  ggplot(.) + 
...
```{r bad_fit, include=TRUE, fig.height=6.2}
