...
1. The `glue::` package allows for simple addition of HTML to ggplot graphics.
...
*  Aside from the Front Range, which is showing some smooth patterns, there's pretty significant volatility in these child poverty estimates. 
