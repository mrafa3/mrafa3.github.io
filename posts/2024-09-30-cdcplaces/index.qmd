...
```{r df_social_needs_depression, include=TRUE, output=FALSE}
...
For this first release of **social needs** indicators, there are only `r n_distinct(df_social_needs$stateabbr)` states included.[^1]
