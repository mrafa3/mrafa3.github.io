...
There's also functionality to overlay data (such as Census data), which would be a neat continuation. Soon, I'd like to use this to map Mount Blue Sky -- our most recent 14er hike in Colorado!
