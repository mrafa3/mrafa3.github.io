...
my.theme <- theme(
  plot.title = ggtext::element_textbox_simple(family="Palatino", face="bold", size=15),
...
combined_acs_data %>% 
  ...
  labs(title='Change in State-level Child Poverty from 2022 to 2023',
       subtitle = 'Size of the color band corresponds to the magnitude of change\n', 
       caption="Source: U.S. Census Bureau's American Community Survey 1-year Estimates\nACS-1 has wider undercertainty bands due to smaller sampling",
