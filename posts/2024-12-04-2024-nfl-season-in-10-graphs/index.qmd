...
play_action_2024 %>% 
  ...
  geom_text(aes(label = plays_TRUE),
            ...
            color = "white", family = "Lexend", fontface = "bold", size = 3) + 
  ...
  labs(x='',
       ...
       subtitle = glue("*Excludes QB scrambles, minimum 20 play action attempts*"),
...
The NFL introduced the dynamic kickoff format for the 2024 season, with the stated goal of increasing returns and reducing head and neck injuries.
...
::: column-margin
Ideally, I would parse play descriptions to determine whether the rate of head and neck injuries has changed on kickoffs; however, starting in the ____ season, {nflfastr} no longer captures this information in play-by-play data. 
