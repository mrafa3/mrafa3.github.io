...
```{r sup_court_issue_history_viz1, include=TRUE, echo=TRUE, fig.height=6.2, fig.align='center'}
...
```{r sup_court_issue_history_viz2, include=TRUE, echo=TRUE, fig.height=6.2, fig.align='center'}
sup_court_term_issue %>% 
  filter(!is.na(issueAreaName)) %>% 
