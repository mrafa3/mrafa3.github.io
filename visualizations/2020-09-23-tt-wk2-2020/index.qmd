...
my_theme <- theme(
  ...
  axis.title = element_text(family="Roboto", color="black", face="bold", size=12), 
  axis.text = element_text(family="Roboto", color="black", size=14), 
...
(plot_rainfall <- annual_rainfall %>% 
  ...
  geom_mark_circle(aes(filter = year == 2019, 
                   ...
                   label.family = c("Roboto", "Roboto Condensed"), label.buffer = unit(6, "cm"), label.fontsize = 10) + 
...
(plot_rain_temp <- plot_rainfall + 
  plot_temperature + 
  plot_annotation(
    title = "Historic Lows in Rainfall and Records High Temperatures<br>a Factor in Australia's Devastating Wildfires",
    subtitle = glue(
      "<br><span style='color:cornflowerblue'>**Total rainfall**</span> and <span style='color:firebrick3'>**average maximum temperature**</span> across Australian cities from 1900 to 2019<br>10-year moving average shown as dotted line"
    ),
    caption = 'Tidy Tuesday Week 2 (2020)<br>**Source**: Australian Bureau of Meterology',
    theme = theme(
      plot.title = element_textbox_simple(family='Roboto', size=24, face='bold'),
      plot.subtitle = element_textbox_simple(family='Roboto', size=15),
