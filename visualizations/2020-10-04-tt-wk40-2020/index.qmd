...
my_theme <- theme(
  ...
  # plot.title = element_text(family="Lora", color="black", face="bold", size=24, hjust=0), 
  # plot.subtitle = element_text(family="Lora", color="black", size=12, hjust=0), 
  # axis.title = element_text(family="Lora", color="gray98", face="bold", size=12), 
  # axis.text = element_text(family="Lora", color="gray98", size=24), 
  axis.ticks = element_blank(), 
  # plot.caption = element_text(family="Lora", color="black", size=12), 
  ...
  # legend.text = element_text(family="Lora", color="black", size=12, hjust=0),
  # legend.position = 'top',
  # strip.text = element_text(family="Lora", color="black", size=14))
```
