...
peak_hist_viz <- peaks %>% 
  ...
  annotate("text", x=8600, y=11, label = 'Mt. Everest', family='Open Sans', size=16) + 
  ...
  my_theme + 
  theme(plot.title = element_textbox(size=rel(5), face='bold'),
        plot.subtitle = element_text(size=rel(3.5)),
        plot.caption = element_textbox(size=rel(1.75), lineheight = .3),
        axis.title.y = element_textbox(hjust = 1, size=rel(2), face='bold'),
        axis.title.x = element_textbox(size=rel(2), face='bold'),
...
paving_everest_viz <- expedition_attempts %>%
  ...
  labs(x='Year (of basecamp)',
       ...
       caption='Tidy Tuesday Week 39 (2020)<br>Data source:The Himalayan Database') + 
  ...
  theme(plot.title = element_textbox(size=rel(5), face='bold'),
        plot.subtitle = element_text(size=rel(3.5)),
        plot.caption = element_textbox(size=rel(1.75), lineheight = .3),
        axis.title.y = element_textbox(hjust = 1, size=rel(2), face='bold', lineheight = .3),
        axis.title.x = element_textbox(size=rel(2), face='bold'),
        axis.text = element_text(size=rel(3.5)))
```
