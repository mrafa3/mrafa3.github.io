...
my_theme <- theme(
  ...
  # plot.title = element_text(family="Open Sans", color="black", face="bold", size=24, hjust=0), 
  # plot.subtitle = element_text(family="Open Sans", color="black", size=12, hjust=0), 
  # axis.title = element_text(family="Open Sans", color="black", face="bold", size=12), 
  # axis.text = element_text(family="Open Sans", color="black", size=18), 
  axis.ticks = element_blank(), 
  # plot.caption = element_text(family="Open Sans", color="black", size=12), 
