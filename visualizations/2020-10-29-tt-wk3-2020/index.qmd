...
my_theme <- theme(
  plot.title = element_markdown(family="Courier Prime", color="black", size=22, hjust=0, margin = margin(b = 5)), 
  plot.subtitle = element_textbox_simple(family="Courier Prime", color="black", size=12, hjust=0, margin = margin(b = 5)), 
...
(strength_viz <- passwords_grp %>% 
  ...
  labs(x='\nRelative strength of password',
       ...
       subtitle = "Each dot represents a unique password from the Knowledge is Beautiful password database<br><span style='margin-top:0.5em;'>**rush2112** is the password with the highest strength score in the dataset</span>",
