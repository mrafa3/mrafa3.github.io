...
my_theme <- theme(
  plot.title = element_markdown(family="Courier Prime", color="black", size=24, hjust=0), 
  plot.subtitle = element_textbox_simple(family="Courier Prime", color="black", size=12, hjust=0), 
