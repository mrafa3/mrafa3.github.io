...
image: "../thumbnails/tt_2019_38.png"
...
![Bump chart illustrating the ranking of U.S. National Parks over time (1904-2016) by the count of visitors. This chart highlights the top 5 national parks as of 2016, and shows their relative popularity over time.](plot_viz_538.png){#fig-1}
...
ggsave(
  filename = here::here(glue("visualizations/tt_{tt_year}_{tt_week}.png")), 
  plot = plot_viz_538,
  width = 10, height = 8, units = "in", dpi = 320
)
here()
# make thumbnail for page
magick::image_read(here::here(glue("visualizations/tt_{tt_year}_{tt_week}.png"))) %>% 
  magick::image_resize(geometry = "400") %>% 
  magick::image_write(here::here(glue("visualizations/thumbnails/tt_{tt_year}_{tt_week}.png")))
```
