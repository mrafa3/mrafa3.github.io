...
ggsave(
  filename = here::here(glue("visualizations/TidyTuesday/{tt_year}/tt_{tt_year}_{tt_week}.png")), 
  plot = plot_viz_538,
  width = 10, height = 8, units = "in", dpi = 320
)

# make thumbnail for page
magick::image_read(here::here(glue("visualizations/TidyTuesday/{tt_year}/tt_{tt_year}_{tt_week}.png"))) %>% 
  magick::image_resize(geometry = "400") %>% 
  magick::image_write(here::here(glue("visualizations/TidyTuesday/{tt_year}/thumbnails/tt_{tt_year}_{tt_week}.png")))
```
